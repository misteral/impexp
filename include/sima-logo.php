...
$file_500 = VM_IMAGE.DS.VENDOR.'_500_'.$fileinfo['filename'].'.'.$fileinfo['extension'];
$file_90 = VM_IMAGE.DS.'resized'.DS.VENDOR.'_500_'.$fileinfo['filename'].'_90x90.'.$fileinfo['extension'];
